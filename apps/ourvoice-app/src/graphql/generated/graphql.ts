...
export type GetPostsQuery = { posts: { totalCount: number, edges: Array<{ node: { id: number, title: string, content: string, files: Array<string> | null, createdAt: any | null, moderatedAt: any | null, publishedAt: any | null, published: boolean, moderated: boolean, authorHash: string | null, authorNickname: string | null, votesUp: number, votesDown: number, categories: Array<{ id: number, name: string }>, comments: Array<{ id: number, content: string }>, votes: Array<{ authorHash: string, voteType: string }> } }>, pageInfo: { endCursor: string, hasNextPage: boolean, startCursor: string } } };
