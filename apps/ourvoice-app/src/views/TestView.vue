<template>
  <div class="h-full w-screen flex flex-col">
    ...
    <div class="flex-1 flex overflow-x-hidden dark:text-gray-400 dark:bg-gray-700">
      <nav
        class="order-first hidden lg:block lg:w-64 2xl:w-96 bg-ourvoice-gray p-5 overflow-y-auto"
      >
        <div
          class="text-ourvoice-blue dark:text-ourvoice-white text-5xl 2xl:text-6xl text-center mb-6"
        >
      ...
      <aside
        class="hidden lg:block lg:w-64 2xl:w-96 bg-ourvoice-gray p-5 overflow-y-auto h-full no-scrollbar"
      >
        <CategoryFilter />
      </aside>
    </div>
